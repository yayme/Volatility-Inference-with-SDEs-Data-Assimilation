...
mse_naive = mean_squared_error(df['sigma_obs'], df['sigma_est_naive'])
mse_kf = mean_squared_error(df['sigma_obs'], df['sigma_est_kf'])
mse_pf = mean_squared_error(df['sigma_obs'], df['sigma_est_pf'])
